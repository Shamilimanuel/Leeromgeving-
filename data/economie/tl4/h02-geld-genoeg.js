...
['Nibud','Nationaal Instituut voor Budgetvoorlichting. Geeft voorlichting over hoe je inkomsten en uitgaven het best op elkaar kunt afstemmen.',0],
['Reserveren','Sparen om een grote, incidentele uitgave te kunnen betalen.',0],
['Spaarmotieven','Redenen om te sparen: voor een doel, voor de rente of uit voorzorg.',1],
['Spaardeposito','Spaarrekening waarop je geld voor een afgesproken tijd vast staat tegen een vast rentepercentage.',1],
['Enkelvoudige rente','Rente die telkens na afloop van een jaar apart wordt uitgekeerd. Je spaartegoed zelf verandert niet.',1],
['Samengestelde rente','Rente-op-rente. De rente wordt na ieder jaar bijgeschreven, en het volgende jaar krijg je ook rente over die bijgeschreven rente.',1],
['Nominale rente','De rente waarmee de bank rekent.',1],
['Reële rente','De nominale rente min de inflatie. Laat zien hoe de koopkracht van je spaargeld verandert.',1],
['Beleggen','Je koopt iets (bijvoorbeeld aandelen, obligaties of crypto\'s) waarvan je verwacht dat het meer waard wordt.',1],
['Rendement','De opbrengst van een belegging, meestal uitgedrukt in een percentage.',1],
['Leenmotieven','Redenen om te lenen, zoals een tijdelijk geldtekort of een dure aankoop.',2],
['Consumptief krediet','Een lening voor de aanschaf van een consumptiegoed.',2],
['Hypothecaire lening','Een lening voor de aankoop van een woning.',2],
['Kredietvormen','Soorten leningen. Bij een bank: persoonlijke lening en salariskrediet. Bij leveranciers: koop op afbetaling en private lease.',2],
['Geldfuncties','Geld kun je gebruiken als ruilmiddel, als rekenmiddel en als spaarmiddel.',3],
['Aanbod van geld','Geld op spaarrekeningen.',3],
['Vraag naar geld','Gezinnen en bedrijven willen geld lenen.',3],
['Rente','De prijs voor geld.',3],
['ECB','Europese Centrale Bank. De centrale bank van de eurozone.',3]
],
cards:[
['Wat is een budgetplan?','Een overzicht van je verwachte inkomsten en uitgaven.',0],
['Waarover adviseert het Nibud?','Over hoe je je inkomsten en uitgaven het best op elkaar kunt afstemmen.',0],
['Wat is reserveren?','Sparen om een grote, incidentele uitgave te kunnen betalen.',0],
['Noem de drie spaarmotieven.','Sparen voor een doel, voor de rente, of uit voorzorg.',1],
...
['Hoe bereken je de reële rente?','Nominale rente min de inflatie.',1],
['Wat is rendement?','De opbrengst van een belegging, meestal uitgedrukt in een percentage.',1],
['In wat voor dingen kun je beleggen?','Bijvoorbeeld aandelen, obligaties, goud, gebouwen of crypto\'s.',1],
['Noem twee leenmotieven.','Bijvoorbeeld een tijdelijk geldtekort overbruggen, of een dure aankoop niet willen uitstellen.',2],
['Wat is consumptief krediet?','Een lening voor de aanschaf van een consumptiegoed.',2],
['Welke twee kredietvormen bied een bank aan?','De persoonlijke lening en het salariskrediet.',2],
['Wat dient als onderpand bij een hypothecaire lening?','Het huis zelf.',2],
['Noem de drie geldfuncties.','Ruilmiddel, rekenmiddel en spaarmiddel.',3],
['Waar komt het aanbod van geld vandaan?','Van spaarders: geld op spaarrekeningen.',3],
['Wie stelt de basisrente vast?','De ECB (Europese Centrale Bank).',3],
['Hoe verdienen banken geld op leningen en spaarrekeningen?','Door een hogere rente te vragen op leningen dan ze vergoeden op spaarrekeningen.',3]
],
quiz:[
['Wat is een budgetplan?',['Een lening bij de bank','Een overzicht van je verwachte inkomsten en uitgaven','Een spaarrekening met vaste rente','Een belastingaangifte'],1,'Een budgetplan is een overzicht van je verwachte inkomsten en uitgaven.'],
['Waarvoor kun je bij het Nibud terecht?',['Voor een hypotheek','Voor advies over het omgaan met geld','Voor beleggingsadvies op de beurs','Voor het invullen van je belastingaangifte'],1,'Het Nibud (Nationaal Instituut voor Budgetvoorlichting) geeft voorlichting over omgaan met geld.'],
['Je zet geld opzij voor een nieuwe laptop over een half jaar. Dit heet...',['beleggen','reserveren','lenen','belasting betalen'],1,'Reserveren is sparen om een grote, incidentele uitgave te kunnen betalen.'],
['Bij welke vorm van rente verandert je spaartegoed zelf niet?',['Samengestelde rente','Enkelvoudige rente','Nominale rente','Reële rente'],1,'Bij enkelvoudige rente wordt de rente elk jaar apart uitgekeerd; je spaartegoed zelf blijft gelijk.'],
['De bank noemt een rente van 2,5%. De inflatie is 3%. Wat is de reële rente?',['5,5%','2,5%','0,5%','-0,5%'],3,'Reële rente = nominale rente − inflatie = 2,5% − 3% = −0,5%.'],
['Wat is rendement?',['De rente op een spaarrekening','De opbrengst van een belegging, meestal in een percentage','De prijs van een aandeel','Een korting op de premie'],1,'Rendement is de opbrengst van een belegging, meestal uitgedrukt in een percentage.'],
['Waarom is beleggen in crypto\'s extra riskant?',['Omdat de bank geen rente geeft over crypto\'s','Omdat crypto\'s geen vaste waarde hebben en snel in prijs kunnen schommelen','Omdat beleggen in crypto\'s verboden is','Omdat de overheid crypto\'s extra belast'],1,'Crypto\'s hebben geen vaste waarde: de prijs kan snel stijgen, maar ook snel dalen.'],
['Voor de aankoop van een woning sluit je een...',['consumptief krediet af','hypothecaire lening af','salariskrediet af','spaardeposito af'],1,'Een hypothecaire lening is speciaal bedoeld voor de aankoop van een woning.'],
['Welke twee kredietvormen bied een bank aan volgens het boek?',['Persoonlijke lening en private lease','Persoonlijke lening en salariskrediet','Koop op afbetaling en private lease','Salariskrediet en koop op afbetaling'],1,'Bij een bank kun je een persoonlijke lening of een salariskrediet afsluiten; koop op afbetaling en private lease loop je via de leverancier.'],
['Wat zijn de drie geldfuncties?',['Ruilmiddel, rekenmiddel, spaarmiddel','Leenmiddel, spaarmiddel, belegmiddel','Betaalmiddel, waardemiddel, wisselmiddel','Chartaal, giraal, digitaal'],0,'De drie geldfuncties zijn ruilmiddel, rekenmiddel en spaarmiddel.'],
['Waar komt het aanbod van geld vandaan?',['Van de overheid','Van spaarders','Van de ECB alleen','Van bedrijven die investeren'],1,'Het aanbod van geld komt van spaarders die geld op spaarrekeningen zetten.'],
['Wie stelt de basisrente in de eurozone vast?',['De Nederlandsche Bank','De ECB','De Belastingdienst','Het CBS'],1,'De ECB (Europese Centrale Bank) stelt de basisrente van de eurozone vast.'],
['Hoe verdienen banken geld?',['Door minder rente te vragen op leningen dan te geven op spaargeld','Door meer rente te vragen op leningen dan te geven op spaargeld','Door geen rente te rekenen','Alleen via de overheid'],1,'Banken verdienen doordat de rente die ze vragen op leningen hoger is dan de rente die ze vergoeden op spaargeld.']
]
});
