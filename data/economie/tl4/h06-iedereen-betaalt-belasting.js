...
['Belastbaar inkomen','Het inkomen waar de belasting over berekend wordt.',0],
['Eigenwoningforfait','Bedrag dat je bij je inkomen moet optellen als je een eigen huis bezit.',0],
['Aftrekposten','Bepaalde kosten die je op je inkomen in mindering mag brengen, zoals de hypotheekrente.',0],
['Bijtelling','Bedrag dat je bij je inkomen moet optellen als je een auto van de zaak ook privé gebruikt.',0],
['Schijventarief','De verdeling van het belastbaar inkomen in schijven, elk met een eigen belastingpercentage.',1],
['Progressief belastingtarief','Het belastingpercentage wordt hoger naarmate het inkomen toeneemt.',1],
['Heffingskorting','Een korting op het bedrag dat je aan inkomstenbelasting moet betalen.',1],
['Vermogen','Het totaal van al je spaargeld en beleggingen na aftrek van je schulden.',1],
['Heffingsvrij vermogen','Het eerste deel van je vermogen waarover je geen belasting hoeft te betalen (in 2025: € 57.000).',1],
['Vermogensrendementsheffing','Belasting in box 3 over inkomen uit vermogen, zoals spaargeld en beleggingen.',1],
['Fictief rendement','Het rendement dat je volgens de overheid hebt op je spaargeld of beleggingen.',1],
['Actieven','Mensen met betaald werk.',2],
['Inactieven','Mensen zonder betaald werk die een uitkering ontvangen, bijvoorbeeld omdat ze arbeidsongeschikt, werkloos of boven de pensioenleeftijd zijn.',2],
['Nivellering','De verschillen tussen de inkomens worden in verhouding kleiner.',2],
['Denivellering','De verschillen tussen de inkomens worden in verhouding groter.',2],
['Vergrijzing','Het aandeel ouderen in de totale bevolking neemt toe en de gemiddelde leeftijd van de bevolking stijgt.',2],
['Draagkrachtbeginsel','Degene die in staat is veel te betalen, moet in verhouding meer betalen.',3],
['Profijtbeginsel','Je betaalt voor het gebruik van goederen of diensten die de overheid levert.',3],
['Motorrijtuigenbelasting','Wegenbelasting. Belasting die je betaalt voor het bezit van een auto.',3],
['Belastingontduiking','Het opzettelijk verkeerd informeren van de overheid om minder belasting te hoeven betalen.',3]
],
cards:[
['Wat is het belastbaar inkomen?','Het inkomen waar de belasting over berekend wordt.',0],
['Uit welke drie boxen bestaat de inkomstenbelasting?','Box 1 (werk en eigen woning), box 2 (aandeelhouders in bv\'s en nv\'s) en box 3 (vermogen).',0],
['Wat zijn aftrekposten?','Kosten die je van je inkomen mag aftrekken, zoals de hypotheekrente, zodat je minder belasting betaalt.',0],
['Wat is een progressief belastingtarief?','Het belastingpercentage wordt hoger naarmate het inkomen toeneemt.',1],
['Hoeveel schijven heeft het schijventarief in box 1?','Drie schijven, elk met een eigen, oplopend belastingpercentage.',1],
['Wat is een heffingskorting?','Een korting op het bedrag dat je aan inkomstenbelasting moet betalen.',1],
['Hoe hoog is het heffingsvrij vermogen in 2025?','€ 57.000. Daarboven betaal je vermogensrendementsheffing.',1],
['Wat is fictief rendement?','Het rendement dat je volgens de overheid hebt op je spaargeld of beleggingen, gebruikt om de vermogensrendementsheffing te berekenen.',1],
['Wat is het verschil tussen actieven en inactieven?','Actieven hebben betaald werk; inactieven hebben geen betaald werk en ontvangen een uitkering.',2],
['Wat is de i/a-ratio?','De verhouding tussen het aantal inactieven en het aantal actieven: aantal inactieven ÷ aantal actieven.',2],
['Wat is het verschil tussen nivellering en denivellering?','Bij nivellering worden inkomensverschillen kleiner; bij denivellering worden ze groter.',2],
['Wat is vergrijzing?','Het aandeel ouderen in de bevolking neemt toe en de gemiddelde leeftijd stijgt.',2],
['Wat is het verschil tussen het draagkracht- en het profijtbeginsel?','Draagkrachtbeginsel: betalen naar wat je kunt missen. Profijtbeginsel: betalen omdat je ergens gebruik van maakt.',3],
['Wat is belastingontduiking en wat kost het de overheid?','Het opzettelijk verkeerd informeren van de overheid om minder belasting te betalen; dit is strafbaar en kost de overheid circa € 22 miljard per jaar.',3]
],
quiz:[
['Waarover wordt de inkomstenbelasting berekend?',['Je brutoloon','Je belastbaar inkomen','Je vermogen','Je spaargeld'],1,'De inkomstenbelasting wordt berekend over je belastbaar inkomen, niet zomaar over je hele inkomen.'],
['In welke box betaal je belasting over inkomen uit werk en eigen woning?',['Box 1','Box 2','Box 3','Geen van alle'],0,'Box 1 gaat over inkomen uit werk en eigen woning. Box 2 is voor aandeelhouders, box 3 voor vermogen.'],
['Hoeveel schijven kent het schijventarief in box 1?',['Één','Twee','Drie','Vier'],2,'Het schijventarief in box 1 bestaat uit drie schijven, elk met een eigen belastingpercentage.'],
['Een belastbaar inkomen van € 80.000 valt in...',['alleen schijf 1','alleen schijf 3','deels schijf 1, deels schijf 2','deels schijf 1, deels schijf 2, deels schijf 3'],3,'De eerste € 38.400 valt in schijf 1, de volgende € 38.400 in schijf 2 en de resterende € 3.200 in schijf 3.'],
['Wat betekent een progressief belastingtarief?',['Iedereen betaalt evenveel belasting','Hogere inkomens betalen in verhouding meer belasting','Lagere inkomens betalen in verhouding meer belasting','De belasting daalt bij een hoger inkomen'],1,'Bij een progressief tarief stijgt het belastingpercentage naarmate het inkomen toeneemt.'],
['Waarover betaal je vermogensrendementsheffing?',['Je brutoloon','Je fictief rendement op vermogen boven het heffingsvrije deel','Je hypotheekrente','Je premies'],1,'In box 3 betaal je belasting over een fictief rendement op je vermogen boven het heffingsvrije deel.'],
['Hoe hoog is het heffingsvrij vermogen in 2025?',['€ 17.000','€ 31.000','€ 57.000','€ 68.500'],2,'In 2025 is het heffingsvrij vermogen € 57.000. Daaronder betaal je geen belasting in box 3.'],
['Wat is het verschil tussen actieven en inactieven?',['Actieven werken niet, inactieven wel','Actieven hebben betaald werk, inactieven ontvangen een uitkering','Er is geen verschil','Actieven betalen geen belasting'],1,'Actieven verdienen hun eigen inkomen; inactieven ontvangen een uitkering, betaald door de premies en belasting van actieven.'],
['Wat gebeurt er bij denivellering?',['Inkomensverschillen worden kleiner','Inkomensverschillen worden groter','Iedereen krijgt hetzelfde inkomen','De staatsschuld daalt'],1,'Bij denivellering worden de verschillen tussen inkomens in verhouding groter.'],
['Wat is een gevolg van vergrijzing voor de AOW?',['De AOW wordt goedkoper','Er zijn steeds meer AOW-gerechtigden ten opzichte van premiebetalers','Er zijn minder ouderen','De AOW verdwijnt volledig'],1,'Door vergrijzing groeit het aantal AOW-gerechtigden sneller dan het aantal premiebetalers, wat de betaalbaarheid onder druk zet.'],
['Motorrijtuigenbelasting is gebaseerd op het...',['draagkrachtbeginsel','profijtbeginsel','solidariteitsbeginsel','progressiebeginsel'],1,'Je betaalt motorrijtuigenbelasting omdat je een auto bezit en van de weg gebruikmaakt: het profijtbeginsel.'],
['Wat is belastingontduiking?',['Legaal minder belasting betalen via aftrekposten','Opzettelijk onjuiste informatie geven om minder belasting te betalen','Belasting te veel betalen','Een korting op de inkomstenbelasting'],1,'Belastingontduiking is het opzettelijk verkeerd informeren van de overheid en is strafbaar.']
]
});
