...
Studiesite voor VMBO-leerlingen. Gewone HTML, CSS en JavaScript — geen
framework, geen npm, geen installatie nodig.

## Openen

Dubbelklik op `index.html`. Werkt meteen in de browser, geen server nodig.
